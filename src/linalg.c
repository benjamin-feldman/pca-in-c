...
int main() {
    ...
    sym_matrix->data[0][0] = 2.92; sym_matrix->data[0][1] = 0.86; sym_matrix->data[0][2] = -1.15;
    sym_matrix->data[1][0] = 0.86; sym_matrix->data[1][1] = 6.51; sym_matrix->data[1][2] = 3.32;
    sym_matrix->data[2][0] = -1.15; sym_matrix->data[2][1] = 3.32; sym_matrix->data[2][2] = 4.57;
    ...
    A->data[0][0] = 1; A->data[0][1] = 1; A->data[0][2] = 0;
    A->data[1][0] = 1; A->data[1][1] = 0; A->data[1][2] = 1;
